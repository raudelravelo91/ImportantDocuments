    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Document>().HasData(
                ...
                new Document { Id = 2, Name = "DocumentName2", Location = "C:/physicalPath", LocationType = LocationType.PhysicalPath},
                new Document { Id = 3, Name = "DocumentName3", Location = "www.google.ca", LocationType = LocationType.URL },
                new Document { Id = 4, Name = "DocumentName3", Description = "Some test description", LocationType = LocationType.None }
            );
